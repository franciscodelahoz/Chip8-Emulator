...
class ColorPalettesManager {
  ...
  private customColorPaletteStorageName: string = database.storage_name.custom_color_palettes;

  private settingsStorageName: string = database.storage_name.settings;
